...
train_dataset = ImageFolder('./data/train/sub-train', transform=transform)
test_dataset = ImageFolder('./data/train/sub-test/', transform=transform)
...
def test():
    ...
    with torch.no_grad():
        ...
        print('Accuracy in the test dataset: %.2f %%' % (100 * correct / total))
